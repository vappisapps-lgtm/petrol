...
## Confirmed Price Difference Rule
...
- Difference litres are calculated as sales report closing meter minus Day Report closing meter for the same date, pump, and product.
- Add the price difference fields in Complete Sales Data and Salesperson Date Data.
- Do not add these fields to Day Report.
- Price changes only once per day for now.
